...
This repository holds samples that use [Loginbuddy](https://github.com/SaschaZeGerman/loginbuddy). Once launched, users can open a browser and will find demo clients, a demo OpenID Connect Provider (OP) and Loginbuddy itself.
...
If you are not sure what Loginbuddy can do for you, please refer to **Deployment**, **Development** and **Configuration** in the [Loginbuddy WIKI](https://github.com/SaschaZeGerman/loginbuddy/wiki).